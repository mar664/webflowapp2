// react-simple-code-editor - Satyajit Sahoo <satyajit.happy@gmail.com> (https://github.com/satya164/)
...
export default class CodeEditor extends React.Component<Props, State> {
  ...
  private _recordChange = (record: Record, overwrite = false) => {
  ...
  render() {
    ...
    return (
      <Box {...rest} sx={{ ...styles.container, ...style }}>
        <Box
          as="pre"
          aria-hidden="true"
          sx={{ ...styles.editor, ...styles.highlight, ...contentStyle }}
          {...(typeof highlighted === "string"
            ? {
                dangerouslySetInnerHTML: {
                  __html: sanitize(highlighted) + "<br />",
                },
              }
        ...
        <Textarea
          ...
          spellCheck={false}
          data-gramm={false}
          _empty={{ "-webkit-text-fill-color": "inherit !important" }}
        />
      </Box>
    );
  }
